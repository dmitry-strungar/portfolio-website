...
Хочу получить первую профессиональную работу в области аналитики данных, где я смогу применять инструменты анализа и визуализации данных для решения бизнес‑задач и поддержки принятия решений.
