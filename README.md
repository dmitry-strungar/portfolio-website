...
Так же в этом репозитории есть моё резюме. 
...
• BI-дашборд: рынок жилой недвижимости России (Power BI)  
...
BI-аналитик с практическим опытом разработки дашбордов, SQL-аналитики и анализа продуктовых метрик.  
Хочу получить профессиональную работу в области аналитики данных, где я смогу применять инструменты анализа и визуализации данных для решения бизнес‑задач и поддержки принятия решений.
